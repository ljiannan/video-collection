...
KEYWORDS = [
    "delicacies"
  #   "sailing fleet", "hot air balloons", "skydiving POV",
  # "paragliding flight", "yacht race", "dirt bike", "FPV drone racing", "plane takeoff",
  #
  #
  # "snowscape drone", "autumn forest", "spring flower field", "summer beach", "flooded area",
  # "frost landscape", "sunset silhouette", "sunrise clouds", "storm approaching", "northern lights",
  #
  #
  # "symmetry shot", "leading lines", "frame within frame", "abstract geometry", "minimalist negative space",
  # "mirror reflection", "color contrast", "motion blur", "macro aerial", "ultra-wide distortion",
  #
  #
  # "wildfire coverage", "rescue mission", "archaeology site", "wildlife tracking", "coral reef underwater",
  # "polar expedition", "desert caravan", "rice terraces", "wind farm", "solar panel array",
  #
  #
  # "movie opening shot", "car commercial", "real estate aerial", "travel promo", "documentary B-roll",
  # "music video drone", "esports event", "expo crowd", "fireworks display", "city promo video",
  #
  #
  # "light and shadow", "texture patterns", "urban geometry", "B&W high contrast", "long exposure light trails",
  # "abstract colors", "close-up details", "surreal composite", "hyperlapse clouds", "creative transition"
]
...
def create_table():
    ...
    try:
        ...
        create_table_query = """
        CREATE TABLE IF NOT EXISTS artlist_video_two (
...
def check_download_state(video_id):
    ...
    try:
        ...
        check_query = """
        SELECT download_state FROM artlist_video_two 
        WHERE id = %s
        """
...
def process_m3u8(video_item,keyword):
    ...
    try:
        ...
        ffmpeg_path = r"D:\ffmpeg\ffmpeg\ffmpeg\ffmpeg-7.0.2-essentials_build\bin\ffmpeg.exe"
        ffmpeg_cmd = [
            ffmpeg_path,
            '-y',
            '-loglevel', 'debug',
